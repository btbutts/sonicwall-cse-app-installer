...
jamf("sonicwall-cse-macos.sh", "device_manager/sonicwall-cse-macos-jamf.sh")
kandji("sonicwall-cse-macos.sh", "device_manager/sonicwall-cse-macos-kandji.sh")
intune_windows("sonicwall-cse-windows.ps1", "device_manager/sonicwall-cse-windows-intune.ps1")